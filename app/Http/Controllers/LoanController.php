...
class LoanController extends Controller
{
    ...
    {
        return view("b2b.loan.index");
    }
    public function personal()
    {
        return view("b2b.loan.personal");
    }
    public function business()
    {
        return view("b2b.loan.business");
    }
    public function gold()
    {
        return view("b2b.loan.gold");
    }
    public function home_salary_employed()
    {
        return view("b2b.loan.home_salary_employed");
    }
    public function home_self_employed()
    {
        return view("b2b.loan.home_self_employed");
    }
    public function property_salary_employed()
    {
        return view("b2b.loan.property_salary_employed");
    }
    public function property_self_employed()
    {
        return view("b2b.loan.property_self_employed");
    }
    /**

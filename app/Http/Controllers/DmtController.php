...
class DmtController extends Controller
{
    ...
    public function index($phone)
    {
        ...
        $banks = BankList::all();
        return view('b2b.dmt.index', compact('detail', 'beneficiary_fetchs', 'banks'));
    }
    /**
    ...
    public function register_remmiter($phone)
    {
        ...
        return view("b2b.dmt.register-remmiter", compact('phone', 'stateresp'));
    }
    /**
    ...
    public function confirm(Request $request)
    {
        ...
        return view('b2b.dmt.confirm', compact('detail', 'beneficiary_fetch_bene', 'amount'));
    }

    public function dotransact(Request $request)
    {
        $remitter_detail = 'dmt/transact/transact';
        $body = array(
        ...
        return view('b2b.dmt.transact', compact('res'));

    }

    public function dmtrefund()
    {
        return view("b2b.dmt.rufundindex");
    }

    public function dmtrefundotp(Request $request)
    {
        $remitter_detail = 'dmt/refund/refund/resendotp';
        $body = array("referenceid" => $request->referenceid, "ackno" => $request->ackno);
        $res = json_decode(ApiController::post($remitter_detail, $body));



        return view("b2b.dmt.refundotp", compact('res'));
    }

    public function dmtrefundcheck()
    {
        $remitter_detail = 'dmt/refund/refund';
        $body = array("referenceid" => $request->referenceid, "ackno" => $request->ackno, "otp" => $request->otp);
        $res = json_decode(ApiController::post($remitter_detail, $body));

        dd($res);
       // return view("b2b.dmt.dmtrefundcheck");
    }

        ...
        <div>
            ...
            <form id="commission_Form">
                ...
                <div class="d-flex flex-column flex-md-row flex-lg-row flex-xl-row flex-xxl-row flex-wrap gap-4">
                    ...
                    @php
                    $commissionData = json_decode($commission->data);
                    @endphp
                    @endforeach
                    <div class="form-group">
                        ...
                        <select class="form-select mb-3 shadow-none text-dark" name="user_type">
                            ...
                            <option value="admin-self" {{ $commissionData->user_type == 'admin-self' ? 'selected' : '' }}>Admin - Self</option>
                            <option value="channel-partner" {{ $commissionData->user_type == 'channel-partner' ? 'selected' : '' }}>Channel Partner</option>
                            <option value="master-distributor" {{ $commissionData->user_type == 'master-distributor' ? 'selected' : '' }}>Master Distributor</option>
                            <option value="distributor" {{ $commissionData->user_type == 'distributor' ? 'selected' : '' }}>Distributor</option>
                            <option value="retailer" {{ $commissionData->user_type == 'retailer' ? 'selected' : '' }}>Retailer</option>
                            <option value="B2C" {{ $commissionData->user_type == 'B2C' ? 'selected' : '' }}>B2C</option>
                            <option value="employee" {{ $commissionData->user_type == 'employee' ? 'selected' : '' }}>Employee</option>
                            <option value="white-label" {{ $commissionData->user_type == 'white-label' ? 'selected' : '' }}>White Label</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select mb-3 shadow-none text-dark" name="plan">
                            ...
                            <option value="{{ $plan->name }}" {{ $commissionData->plan == $plan->name ? 'selected' : '' }}>{{ $plan->name }}</option>
                            @endforeach
                        </select>
                    </div>

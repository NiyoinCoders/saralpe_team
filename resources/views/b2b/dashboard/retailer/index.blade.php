                        ...
                        <div class="pb-4 border-0 card-header rounded text-danger">
                            <div class="p-4 border border-white rounded primary-gradient-card ">
                                <div class="d-flex justify-content-between align-items-center text-white">
                                    <div>
                                        <h5 class="font-weight-bold text-black">Axis Bank Account</h5>
                                        <P class="mb-0"><font color="##0c112e"> SaralPe Private Limited</font></P>
                                    </div>
                                </div>
                                <div class="my-4 text-white">
                                    <div class="card-number">
                                        <span class="font-weight-bold text-black">Account Number. </span><br>
                                        <span class="fs-5 me-2"><font color="##0c112e">8941415582622</font></span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between text-white">
                                    <h6 class="text-white"><font color="##0c112e">UTIB0CCH274</font></h6>
                                </div>
                            </div>
                        </div>
                    </div>

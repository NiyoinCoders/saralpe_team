@extends("layouts.app")
@section("title","payment_credit_debit_report")
@section("content")
          ...
          <div class="col-md-12"> <!-- Start of Col-md-12 -->
            <div class="card card-outline card-warning"> <!-- Start of Card -->
              <div class="card-header"> <!-- End of Card Header -->
                <h6 class="card-title"><strong>Payment Credit &amp; Debit Report</strong></h6>

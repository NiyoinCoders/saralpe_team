...
<script>
  ...
  console.log('submitted')
     ...
     $("form").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('fetchconsumerdetails') }}",
                method: "POST",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                ...
                success: function(response) {
                    ...
                    $("input[name='maxBillAmount']").val(response.data.bill_fetch.maxBillAmount);
...
var longitude = $('#longitude').val();
 ...
 var maxBillAmount = $("input[name='maxBillAmount']").val();
...
$.ajax({
    ...
    success: function(response) {
        // Handle the response from the server
        if(response){
          $('alert').append('Success Transaction');
        }
        console.log(response);

        ...
        <div class="row">
            <div class="col-sm-12 col-lg-4">
                <div class="card">
                    ...
                    @endif
                            <h5 class="card-title">Postpaid Mobile Recharge</h5>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-lg-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Mobile Postpaid COMMENT</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="" id="fetchbill">

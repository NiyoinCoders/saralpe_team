<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
        ...
        <a href="{{route('paymentrequest')}}" class="btn btn-outline-primary rounded-pill btn-sm btn-float-left">Load Money (UPI)</a>
        ...
        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                ...
                @endif
                <button type="button" class="btn btn-outline-primary rounded-pill" style="right:10px;">
                    @if(Auth::user()->roles->name == "Retailer")
                ...
                <button type="button" class="btn btn-outline-primary rounded-pill" onclick="discoverAvdm();">CHECK DEVICE</button>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{route('ekyc')}}">User Ekyc</a></li>
                        <li><a class="dropdown-item" href="{{route('webkyc')}}">Web kyc</a></li>

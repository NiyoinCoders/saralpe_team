...
<head>
    ...
    {{-- <title>{{ config('settings.website_name') }} | @yield('title')</title>
     --}}
     <title>PayWing Private Limited</title>
    ...
    /* Style for scrollbar */
    /* These styles might not work in all browsers */
    /* You may need to use vendor prefixes for cross-browser compatibility */
    /* Also, note that scrollbar styling support is limited */
...
<body class="  ">
    ...
    <aside class="sidebar sidebar-default navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start" style="height: 72px;">
            @if (Auth::user()->roles->name == "Retailer")
            <a href="{{route('retailer.dashboard')}}" class="navbar-brand">
          ...
          <!--  <a href="index.php" class="navbar-brand"> -->
                ...
                <!--logo End-->
                <img src='{{asset('assets/images/'.env('logo').'')}}' style="height: 50px; margin-left:22px;"/>
            </a>
                        ...
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p>Every Retailer's Ally, Making Work Easy.!</p>
                                </div>
                             <!--   <div>
